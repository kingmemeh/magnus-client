        ...
        <div className="modal__wrapper">
          <div className="modal__image-container">
            <img
              ...
              src={`${baseImageURL}${selected.backdrop_path}`}
              alt={selected.name}
            />
          </div>
          <div className="modal__content">
                  ...
                  <div className="reviews__content-container">
                    {review.content ? (
                      <p className="reviews__content">
                        {truncateString(review.content, 250)}
                      </p>
                    ) : (
                      <p>No Reviews</p>
                    )}
            ...
            <div>
              <BsXLg className="modal__button" onClick={close} />
            </div>
            <h3>Credits</h3>
            <div className="credits">
              {credits.slice(0, 25).map((credit) => (
                <div className="credits__card">
                  <img
                    className="credits__card-avatar"
                    src={`${baseImageURL}${credit.profile_path}`}
